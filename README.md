...
## Overview
This project focuses on developing a machine learning-based bearing fault detection system using vibration signal analysis under both benchmark and real experimental conditions.
